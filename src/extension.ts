...
import { EmberComponentsProvider, FileTreeElement } from './ember-component-provider';
...
export function activate(context: vscode.ExtensionContext) {
    ...
    context.subscriptions.push(vscode.window.registerTreeDataProvider('emberComponents', emberComponentsProvider));
    ...
    console.log('Congratulations, your extension "ember-component-view" is now active!');
}
